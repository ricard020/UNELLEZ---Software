    ...
    public class ConnectionViewModel : ViewModelBase
    {
        ...
        public string ServerName 
        {
            ...
            set
            {
                ...
                ((ViewModelCommand)CheckConnectionCommand).RaiseCanExecuteChanged();
            }
        }
        ...
        public bool ConnectionChecked
        {
            ...
            set
            {
                ...
                ((ViewModelCommand)SaveConnectionCommand).RaiseCanExecuteChanged();
            }
        }
        ...
        public ConnectionViewModel(IToastMessagesUtility toastMessagesUtility, ICryptographyDataUtility cryptographyDataUtility, IDatabaseServices databaseServices)
        {
            _databaseServices = databaseServices;
            _toastMessageUtility = toastMessagesUtility;
            _cryptographyDataUtility = cryptographyDataUtility;
            CheckConnectionCommand = new ViewModelCommand(ExecuteCheckConnectionCommand, CanExecuteCheckConnectionCommand);
            SaveConnectionCommand = new ViewModelCommand(ExecuteSaveConnectionCommand, CanExecuteSaveConnectionCommand);
        }
