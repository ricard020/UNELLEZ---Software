...
namespace REPOSITORY.SessionRepository
{
    public interface ISessionRepository
    {
        ...
        /// <returns>Devuelve una colección genérica de las sesiones encontradas, un bool para indicar si la operación fue exitosa y un mensaje de error en caso de que lo de.</returns>
        Task<(ICollection<SessionEntity>, int, bool, string)> GetAllByFilters(DateTime? dateI, int idEntrenador, string? descrip, int skip);

        /// <summary>
        /// Obtiene todas las sesiones creadas de manera offline.
        /// </summary>
        /// <returns>Devuelve una colección genérica de las sesiones encontradas, un bool para indicar si la operación fue exitosa y un mensaje de error en caso de que lo de.</returns>
        Task<(ICollection<SessionEntity>, bool, string)> GetAllSesionsInLocalDB();
    }
}
