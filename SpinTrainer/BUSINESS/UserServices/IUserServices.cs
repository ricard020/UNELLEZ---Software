...
namespace SERVICES.UserServices
{
    public interface IUserServices
    {
        ...
        /// </summary>
        /// <returns>Devuelve una ObservableCollection con los usuarios encontrados, un bool para indicar si la operación se culmino con éxito o no, un string como mensaje de error en caso de que lo haya.</returns></returns>
